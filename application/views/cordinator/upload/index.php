...
<?php echo form_open_multipart('upload/conf', array('name' => 'form1')); ?>
...
<div class="btnArea">
    <ul>
        ...
        <li><a href="#" id="upload" class="upload"><?php echo img(array('src' => 'img/btn016.jpg', 'alt' => 'ファイルアップロード', 'width' => '124', 'height' => '24')) ?></a></li>
    </ul>
</div>
<?php echo form_close(); ?>
...
<?= form_open("upload/delete", array("id" => "delete_form")) ?>
<?= form_input(array("id" => "delete_id", "name" => "id", "hidden" => "hidden")) ?>
<?= form_open("upload/delete") ?>
