    ...
    $(function() {
        ...
        $("#delete").click(function() {
            if (window.confirm('ユーザを削除するとBOXも削除されます。よろしいですか？')) {
                $('.form1').attr("action", "/admin/transplantUser/delete");
                $('.form1').submit();
            } else {
        ...
        $("#edit").click(function() {
            $('.form1').attr("action", "/admin/transplantUser/edit");
            $('.form1').submit();
        });
    });
</script>
...
<div class="btnArea">
    <ul>
        ...
        <li><?php echo anchor('admin/transplantUser', img(array('src' => 'img/btn003.jpg', 'alt' => '戻る', 'width' => '124', 'height' => '24', 'id' => 'back', 'class' => 'back'))) ?></li>
