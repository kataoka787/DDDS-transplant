<script type="text/javascript">
    ...
    function searchPage(id) {
        resetCSRFToken();
        document.getElementById("form1").action = "/admin/transplantUser/" + id;
...
<div class="sTable2">
    ...
    <?php endif; ?>
    <?php echo form_open('admin/transplantUser', array('name' => 'form1', 'id' => 'form1', 'class' => 'form1')); ?>
    <table width="100%" border="0" cellpadding="6" cellspacing="3" class="list">
        ...
        <tr>
            <td width="30%">都道府県</td>
            <td width="70%">
                <select name="pref_id" id="pref" class="pref">
    ...
    <?php if ($this->session->userdata('affiliation_mst_id') == '1') : ?>
        <div class="btnArea">
            <ul>
                <li><?php echo anchor('admin/transplantUser/edit', img(array('src' => 'img/btn020.jpg', 'alt' => '新規登録', 'width' => '124', 'height' => '24'))) ?></li>
                <li><?php echo anchor('admin/transplantUser/csv', img(array('src' => 'img/btn036.jpg', 'alt' => 'CSVダウンロード', 'width' => '124', 'height' => '24'))) ?></li>
            </ul>
        </div>
    <?php endif; ?>
</div>
...
<table width="100%" border="0" cellpadding="6" cellspacing="3" class="list">
    ...
    <?php foreach ($list as $val) : ?>
        <tr>
            ...
            <td>
                <a href="#" onClick='goPage("<?php echo $val->id ?>");'>変更 / 削除</a>
            </td>
        </tr>
    <?php endforeach; ?>
</table>
...
<?php echo form_open('admin/transplantUser/confirm', array('name' => 'list', 'class' => 'list', 'id' => 'list')); ?>
