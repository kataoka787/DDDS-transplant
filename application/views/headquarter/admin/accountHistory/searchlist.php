<script type="text/javascript">
    function searchPage(id) {
        document.getElementById("form1").action = "/admin/accountHistory/" + id;
    ...
    $(function() {
        ...
        $(".search").click(function() {
            $('#form1').attr('action', '/admin/accountHistory');
            $('#hidden_btn').attr('value', '1');
            $('#form1').submit();
        });

        $(".csv").click(function() {
            $('#form1').attr('action', '/admin/accountHistory/csv');
            $('#form1').submit();
        });
...
<table width="100%" border="0" cellpadding="6" cellspacing="3" class="list">
    ...
    <?php foreach ($list as $key => $val) : ?>
        <tr>
            ...
            <td><?php echo     nl2br($val->contents) ?></td>
        </tr>
    <?php endforeach; ?>
</table>